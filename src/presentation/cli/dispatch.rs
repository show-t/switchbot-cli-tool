use clap::Parser;
use crate::domain::models::value_objects::{BrightnessValue, ColorTemperatureValue, ColorValues, Command};
...
pub async fn dispatch<'a, R: IDeviceRepository>(use_case: &'a ControlDeviceUseCase<'a, R>) -> Result<()> {
    let args = Args::parse();
